...
\cvitem{}{\labelitemi\hspace{2mm}
	Project: Agricultural pest modeling, utilizing time-series environmental data and user-submitted data from disparate sources. Constructed a unified modeling pipeline for regression and classification pest predictions.
}
\cvitem{}{\labelitemi\hspace{2mm}
